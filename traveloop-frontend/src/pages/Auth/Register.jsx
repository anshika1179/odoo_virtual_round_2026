  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-amber-700/10 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 left-1/4 w-96 h-96 bg-orange-600/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-lg animate-fadeInUp relative">
        <div className="text-center mb-8">
          ...
          <p className="text-amber-700 mt-2">Start planning your next adventure</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  <User size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-amber-600" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  <Phone size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-amber-600" />
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="password" className="input-glass pl-12" placeholder="Min 6 chars" value={form.password} onChange={set('password')} required />
                </div>
              </div>
            </div>
            ...
            <div>
              <label className="block text-sm font-medium text-amber-800 mb-1.5">Additional Info</label>
          ...
          <p className="text-center text-amber-700 text-sm mt-6">
            Already have an account? <Link to="/login" className="text-amber-700 hover:text-amber-900 font-medium">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
